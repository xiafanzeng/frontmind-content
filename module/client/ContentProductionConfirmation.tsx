...
export function createContentProductionConfirmation(
  useWorkspaceDraftGuard: (input: { dirty: boolean; label: string }) => void = () => {},
) {
return function ContentProductionConfirmation({
  progress,
  busy,
  onPendingChange,
  onAction,
